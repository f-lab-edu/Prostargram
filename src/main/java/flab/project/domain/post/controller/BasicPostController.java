...
public class BasicPostController {
    ...
    @PutMapping(value = "/posts/basic")
    public SuccessResponse<Void> putBasicPost(
            @LoggedInUserId Long userId,
            @RequestBody @Validated UpdateBasicPostRequest basicPost
    ) {
        postService.update(userId, basicPost);
